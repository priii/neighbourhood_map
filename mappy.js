            ...
            function getStreetView(data, status) {
              if (status == google.maps.StreetViewStatus.OK) {
                ...
                var heading = google.maps.geometry.spherical.computeHeading(
                  ...
                  // finding venue_id for the restaurants
                  var rest_idx = 0;
                    for(var i=0;i< restaurants.length; i++){
                ...
                success: function(data){
                  ...
                  infowindow.setContent('<div>' + marker.name+ '</div><hr><div id="pano"></div><br>'+ '<div><br><h3>'+'3 customer reviews about this restaurant'+'</h3></div>'+tip1 + '<div><br>'+ tip2 +'</div><br>'+ '<div>'+ tip3 +'</div>');
                   var panoramaOptions = {
